	...
	\begin{center}
		\begin{tikzpicture}
			\begin{axis}[
					...
					xmin=-4, xmax=4,
					ymin=0,ymax=4,
					restrict y to domain=0:4, domain=-4:4, width=\linewidth, height=\linewidth, grid=major, samples=200,  ylabel=$f(x)$, xlabel=$x$]
	...
	\begin{center}
		\begin{tikzpicture}
			\begin{axis}[
					...
					xmin=-4, xmax=4,
					ymin=0,ymax=4,
					restrict y to domain = 0:4, domain=-4:4, width=\textwidth, height=\textwidth, grid=major, samples=200,  ylabel=$f(x)$, xlabel=$x$]
				\addplot[black, thick] {x^2};
			\end{axis}
		\end{tikzpicture}
	\end{center}
...
\begin{teorema}{Limiti succesioni crescenti}
